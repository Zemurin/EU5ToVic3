...
cp Data_Files/log.txt ../Release-Linux/EU5ToVic3/
cp Data_Files/configuration-example.txt ../Release-Linux/EU5ToVic3/
cp Resources/librakaly.so ../Release-Linux/EU5ToVic3
...
# Copy configurables
rm -rf Release-Linux/EU5ToVic3/configurables
cp -r Data_Files/configurables ../Release-Linux/EU5ToVic3

# Copy blankmod
rm -rf Release-Linux/EU5ToVic3/blankMod
cp -r Data_Files/blankMod ../Release-Linux/EU5ToVic3
